...
@section('content')
    ...
    @if(!empty($is_screen_access))
        ...
        <form method="POST" action="{{ route('backend.projects.store') }}">
            @csrf
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12 mb-4">
                                    <label>Slug</label>
                                    <input class="form-control" type="text" id="slug" name="slug" placeholder="Enter here...." value="{{ isset($project) ? $project->slug : '' }}" readonly>
                                    <label class="text-danger fw-bold mt-1 d-none" id="slug-warning">Slug already exists!</label>
                                </div>

                                <div class="col-sm-12 mb-4">
                                    <label>Title (ENGLISH) *</label>
                                    <input class="form-control" type="text" id="main-title" name="en_title" placeholder="Enter here...." value="{{ isset($project) ? $project->en_title : '' }}">
                                </div>

                                <div class="col-sm-12 mb-4">
                                    <label>Content (ENGLISH)</label>
                                    <textarea id="content-en" name="en_content">
                                    {{ isset($project) ? $project->en_content : '' }}
                                </textarea>
                                </div>
                                ...
                                <div class="col-sm-12 mb-4">
                                    ...
                                    <input class="form-control" type="text" id="title-si" name="si_title" placeholder="Enter here...." value="{{ isset($project) ? $project->si_title : '' }}">
                                </div>

                                <div class="col-sm-12 mb-4">
                                    <label>Content (SINHALA)</label>
                                    <textarea id="content-si" name="si_content">
                                    {{ isset($project) ? $project->si_content : '' }}
                                </textarea>
                                </div>
                                ...
                                <div class="col-sm-12 mb-4">
                                    ...
                                    <input class="form-control" type="text" id="title-ta" name="ta_title" placeholder="Enter here...." value="{{ isset($project) ? $project->ta_title : '' }}">
                                </div>

                                <div class="col-sm-12 mb-4">
                                    <label>Content (TAMIL)</label>
                                    <textarea id="content-ta" name="ta_content">
                                    {{ isset($project) ? $project->ta_content : '' }}
                                </textarea>
                                </div>
