                        ...
                        <form method="GET" action="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 d-flex align-items-end">
                                    ...
                                    <a href="{{ url('admin/projects') }}" class="btn btn-outline-dark waves-effect waves-light ms-2">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="live-preview">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="bg-light rounded p-1">
                                                            <img src="{{ asset('assets/common/images/uploads/' .$project->primary_image) }}" class="img-fluid d-block" alt="Img">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <p class="mb-1">{{ $project->en_title }}</p>
                                                        <p class="mb-1 text-muted">{{ $project->si_title }}</p>
                                                        <p class="mb-0">{{ $project->ta_title }}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p class="mb-0"><span class="badge {{ status($project->status)->class }}">{{ status($project->status)->text }}</span></p>
                                                    </td>
                                                    <td class="text-end">
                                                        <a href="{{ url('projects/' . $project->slug) }}" target="_blank" class="btn btn-primary btn-sm waves-effect waves-light" data-bs-toggle="tooltip" data-bs-placement="top" title="View"><span class="mdi mdi-magnify"></span></a>
                                                        <a href="{{ route('backend.projects.edit', $project->uuid) }}" class="btn btn-primary btn-sm waves-effect waves-light" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><span class="mdi mdi-pencil"></span></a>
                                                        <a href="javascript:void(0);" class="btn btn-danger btn-sm waves-effect waves-light delete" data-id="{{ $project->id }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><span class="mdi mdi-delete"></span></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                            ...
                            <div class="mt-5">
                                {{--Paginaiton--}}
                                {!! $projects->links('vendor.pagination.backend') !!}
                            </div>
                        </div>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            ...
            $('.table').on('click', '.delete', function ($e){
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        setTimeout(function() {
                            $.ajax({
                                url: "{{ route('backend.projects.delete') }}",
                                type: 'POST',
                                data: {
                                    id: $id,
                                    _token: csrf_token()
                                ...
                                success: function ($response, $textStatus, $jqXHR) {
                                    Swal.fire('Done!', 'Project has been deleted!', 'success');
