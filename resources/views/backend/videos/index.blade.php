...
@section('header_buttons')
    <div class="row">
        <div class="col-sm-12 d-flex justify-content-end mb-3">
            <a href="{{ url('admin/videos/create') }}" class="btn btn-primary">
                        ...
                        <form method="GET" action="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 d-flex align-items-end">
                                    ...
                                    <a href="{{ url('admin/videos') }}" class="btn btn-outline-dark waves-effect waves-light ms-2">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">All Videos</h4>
                    ...
                    <div class="card-body">
                        <div class="live-preview">
                                        ...
                                        <table class="table table-hover table-striped align-middle table-nowrap mb-0">
                                            ...
                                            @foreach($videos as $video)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="mb-1">{{ $video->en_title }}</p>
                                                        <p class="mb-1 text-muted">{{ $video->si_title }}</p>
                                                        <p class="mb-0">{{ $video->ta_title }}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p class="mb-0"><span class="badge {{ status($video->status)->class }}">{{ status($video->status)->text }}</span></p>
                                                    </td>
                                                    <td class="text-end">
                                                        <a href="{{ url('videos/' . $video->slug) }}" target="_blank" class="btn btn-primary btn-sm waves-effect waves-light" data-bs-toggle="tooltip" data-bs-placement="top" title="View"><span class="mdi mdi-magnify"></span></a>
                                                        <a href="{{ route('backend.videos.edit', $video->uuid) }}" class="btn btn-primary btn-sm waves-effect waves-light" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><span class="mdi mdi-pencil"></span></a>
                                                        <a href="javascript:void(0);" class="btn btn-danger btn-sm waves-effect waves-light delete" data-id="{{ $video->id }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><span class="mdi mdi-delete"></span></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                            ...
                            <div class="mt-5">
                                {{--Paginaiton--}}
                                {!! $videos->links('vendor.pagination.backend') !!}
                            </div>
                        </div>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            ...
            $('.table').on('click', '.delete', function ($e){
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        setTimeout(function() {
                            $.ajax({
                                url: "{{ route('backend.videos.delete') }}",
                                type: 'POST',
                                data: {
                                    id: $id,
                                    _token: csrf_token()
                                ...
                                success: function ($response, $textStatus, $jqXHR) {
                                    Swal.fire('Done!', 'Video has been deleted!', 'success');
