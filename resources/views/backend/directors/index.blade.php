...
@section('header_buttons')
    <div class="row">
        <div class="col-sm-12 d-flex justify-content-end mb-3">
            <a href="{{ url('admin/directors/create') }}" class="btn btn-primary">
                        ...
                        <form method="GET" action="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 d-flex align-items-end">
                                    ...
                                    <a href="{{ url('admin/directors') }}" class="btn btn-outline-dark waves-effect waves-light ms-2">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">All Directors</h4>
            ...
            $('.table').on('click', '.delete', function ($e){
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        setTimeout(function() {
                            $.ajax({
                                url: "{{ route('backend.directors.delete') }}",
                                type: 'POST',
                                data: {
                                    id: $id,
                                    _token: csrf_token()
                                ...
                                success: function ($response, $textStatus, $jqXHR) {
                                    Swal.fire('Done!', 'Director has been deleted!', 'success');
