    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Senior Staff Members</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">NHDA Admin</a></li>
                        <li class="breadcrumb-item active">Senior Staff Members</li>
                    </ol>
                </div>
...
@section('header_buttons')
    <div class="row">
        <div class="col-sm-12 d-flex justify-content-end mb-3">
            <a href="{{ url('admin/senior-staff-members/create') }}" class="btn btn-primary">
                        ...
                        <form method="GET" action="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 d-flex align-items-end">
                                    ...
                                    <a href="{{ url('admin/senior-staff-members') }}" class="btn btn-outline-dark waves-effect waves-light ms-2">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">All Senior Staff Members</h4>
                    ...
                    <div class="card-body">
                        <div class="live-preview">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="bg-light rounded p-1">
                                                            <img src="{{ asset('assets/common/images/uploads/' .$member->image) }}" class="img-fluid d-block" alt="Img">
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-center">
                                                        <p class="mb-1">{{ $member->designation }}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p class="mb-0"><span class="badge {{ status($member->status)->class }}">{{ status($member->status)->text }}</span></p>
                                                    </td>
                                                    <td class="text-end">
                                                        <a href="{{ route('backend.seniorStaffMembers.edit', $member->uuid) }}" class="btn btn-primary btn-sm waves-effect waves-light" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><span class="mdi mdi-pencil"></span></a>
                                                        <a href="javascript:void(0);" class="btn btn-danger btn-sm waves-effect waves-light delete" data-id="{{ $member->id }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><span class="mdi mdi-delete"></span></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                            ...
                            <div class="mt-5">
                                {{--Paginaiton--}}
                                {!! $members->links('vendor.pagination.backend') !!}
                            </div>
                        </div>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            ...
            $('.table').on('click', '.delete', function ($e){
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        setTimeout(function() {
                            $.ajax({
                                url: "{{ route('backend.seniorStaffMembers.delete') }}",
                                type: 'POST',
                                data: {
                                    id: $id,
                                    _token: csrf_token()
                                ...
                                success: function ($response, $textStatus, $jqXHR) {
                                    Swal.fire('Done!', 'Senior Staff Member has been deleted!', 'success');
