...
@section('header_buttons')
    <div class="row">
        <div class="col-sm-12 d-flex justify-content-end mb-3">
            <a href="{{ url('admin/senior-staff-members') }}" class="btn btn-primary">
...
@section('content')
    ...
    @if(!empty($is_screen_access))
        ...
        <form method="POST" action="{{ route('backend.seniorStaffMembers.store') }}">
            @csrf
                ...
                <div class="col-sm-8">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Senior Staff Member Details</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
    ...
    <script>
        ...
        $('.thumb_crop').click(function(event){
            ...
            $image_thumb.croppie('result', {
                ...
                $.ajax({
                    url: "{{ route('backend.seniorStaffMembers.imageUpload') }}",
                    type: "POST",
                    data: {
                        image:response,
                    },
        ...
        function getSlug(){
            ...
            if(!$isSending){
                $.ajax({
                    url: "{{ route('backend.seniorStaffMembers.slugGenerator') }}",
                    dataType: 'json',
                    data: {
                        id: $id,
                        title: $title,
