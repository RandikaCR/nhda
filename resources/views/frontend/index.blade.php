                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-3">
                                <div class="hero-image" data-ani="slideinup" data-ani-delay="0.4s">
                                    <img src="{{ asset('assets/frontend/img/hero/hero_2_1.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-slide">
                    <div class="container">
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-3">
                                <div class="hero-image" data-ani="slideinup" data-ani-delay="0.4s">
                                    <img src="{{ asset('assets/frontend/img/hero/hero_2_2.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-slide">
                    <div class="container">
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-3">
                                <div class="hero-image" data-ani="slideinup" data-ani-delay="0.4s">
                                    <img src="{{ asset('assets/frontend/img/hero/hero_2_3.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="program-card">
                                <div class="program-img">
                                    <a href="program-details.html">
                                        <img src="{{ asset('assets/frontend/img/program/program_1_1.jpg') }}" alt="program image">
                                    </a>
                                </div>
                        ...
                        <div class="swiper-slide fadeinup wow">
                            <div class="program-card">
                                <div class="program-img">
                                    <a href="program-details.html">
                                        <img src="{{ asset('assets/frontend/img/program/program_1_2.jpg') }}" alt="program image">
                                    </a>
                                </div>
                                <div class="program-content">
                        ...
                        <div class="swiper-slide fadeinup wow">
                            <div class="program-card">
                                <div class="program-img">
                                    <a href="program-details.html">
                                        <img src="{{ asset('assets/frontend/img/program/program_1_3.jpg') }}" alt="program image">
                                    </a>
                                </div>
                                <div class="program-content">
                        ...
                        <div class="swiper-slide fadeinup wow">
                            <div class="program-card">
                                <div class="program-img">
                                    <a href="program-details.html">
                                        <img src="{{ asset('assets/frontend/img/program/program_1_4.jpg') }}" alt="program image">
                                    </a>
                                </div>
                                <div class="program-content">
...
==============================-->
    <section class="about2-area position-relative overflow-hidden space-bottom" id="about-sec">
        <span class="about-shape1 shape-mockup movingX" data-top="35%" data-left="4%">
            <img src="{{ asset('assets/frontend/img/shape/about-2-1.png') }}" alt="Stadum About area">
        </span>
        <span class="about-shape2 shape-mockup movingX" data-bottom="0%" data-right="6%">
            <img src="{{ asset('assets/frontend/img/shape/about-2-2.png') }}" alt="Stadum About area">
        </span>
        <div class="container">
            <div class="row gy-60 align-items-center justify-content-center">
                <div class="col-xl-6">
                    <div class="img-box2">
                        <img src="{{ asset('assets/frontend/img/about/about-thumb2-1.jpg') }}" alt="About">
                        <img src="{{ asset('assets/frontend/img/about/about-thumb2-2.jpg') }}" alt="About">
                        <img src="{{ asset('assets/frontend/img/about/about-thumb2-3.jpg') }}" alt="About">
                    </div>
                </div>
                <div class="col-xl-6">
...
Video Area
==============================-->
    <div class="video-area-1 position-relative overflow-hidden " data-overlay="title" data-opacity="3" data-bg-src="{{ asset('assets/frontend/img/video-banner/video-bg-1-1.jpg') }}">
...
==============================-->
    <section class="scholar-area scholar-style position-relative space-top overflow-hidden">
                ...
                <div class="col-xl-6">
                    <div class="scholar-right">
                        <div class="scholar-imgbox ms-xl-5 wow fadeInUp" data-wow-delay=".5s">
                            <img src="{{ asset('assets/frontend/img/scholarship/scholar-1-1.png') }}" alt="image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="about-shep-2 shape-mockup d-none d-xxl-block" data-top="0%" data-left="0%">
            <img src="{{ asset('assets/frontend/img/shape/shape-3.png') }}" alt="shape">
        </div>
        <div class="about-shep-2 shape-mockup d-none d-xxl-block" data-bottom="4%" data-left="0%">
            <img src="{{ asset('assets/frontend/img/shape/shape-4.png') }}" alt="shape">
        </div>
    </section><!--==============================
Alumni Area
==============================-->
    ...
    <section class="alumni-area position-relative space overflow-hidden">
        <div class="alumni-shape shape-mockup jump-reverse" data-right="2%" data-top="15%">
            <img src="{{ asset('assets/frontend/img/shape/alumni-2-1.png') }}" alt="shape">
        </div>
        <div class="container">
                ...
                <div class="col-xl-6">
                    <div class="alumni-imgbox">
                        <div class="alumni-img global-img">
                            <img src="{{ asset('assets/frontend/img/alumni/alumni-1-1.jpg') }}" alt="img">
                        </div>

                        <div class="alumni-img global-img">
                            <img src="{{ asset('assets/frontend/img/alumni/alumni-1-2.jpg') }}" alt="img">
                        </div>

                        <div class="alumni-img global-img">
                            <img src="{{ asset('assets/frontend/img/alumni/alumni-1-3.jpg') }}" alt="img">
                        </div>

                        <div class="alumni-img global-img">
                            <img src="{{ asset('assets/frontend/img/alumni/alumni-1-4.jpg') }}" alt="img">
                        </div>

                        <div class="alumni-img global-img">
                            <img src="{{ asset('assets/frontend/img/alumni/alumni-1-5.jpg') }}" alt="img">
                        </div>

                        <div class="alumni-img global-img">
                            <img src="{{ asset('assets/frontend/img/alumni/alumni-1-6.jpg') }}" alt="img">
                        </div>
    ...
    <section class="academic1-area space bg-gray overflow-hidden" id="academics-sec">
                ...
                <div class="swiper th-slider has-shadow" id="academicSlider2" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"1"},"992":{"slidesPerView":"2"},"1200":{"slidesPerView":"3"},"1400":{"slidesPerView":"3", "spaceBetween": "24"}},"autoHeight": "true", "autoplay" : "false"}'>
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="academic-card style2">
                                <div class="academic-img">
                                    <img src="{{ asset('assets/frontend/img/academic/academic1-1.jpg') }}" alt="img">
                        ...
                        <div class="swiper-slide">
                            <div class="academic-card style2">
                                <div class="academic-img">
                                    <img src="{{ asset('assets/frontend/img/academic/academic1-2.jpg') }}" alt="img">
                                    <div class="academic-tag">
                        ...
                        <div class="swiper-slide">
                            <div class="academic-card style2">
                                <div class="academic-img">
                                    <img src="{{ asset('assets/frontend/img/academic/academic1-3.jpg') }}" alt="img">
                                    <div class="academic-tag">
        ...
        <div class="about-shep-2 movingX shape-mockup d-none d-xxl-block" data-bottom="1%" data-left="1%">
            <img src="{{ asset('assets/frontend/img/shape/shape-5.png') }}" alt="shape">
        </div>
    </section>
    <section class="professor-area-1 position-relative space overflow-hidden" id="professor-sec">
        <div class="shape-mockup" data-top="0%" data-left="0%">
            <img src="{{ asset('assets/frontend/img/shape/shape-6.png') }}" alt="Stadum">
        </div>
        <div class="container">
            <div class="row justify-content-lg-between justify-content-center align-items-center">
            ...
            <div class="row gy-30">
                <div class="col-xl-6">
                    <div class="professor-card wow fadeInLeft" data-wow-delay=".2s">
                        <div class="professor-img global-img">
                            <img src="{{ asset('assets/frontend/img/professor/professor-1-1.png') }}" alt="professor image">
                        </div>
                ...
                <div class="col-xl-6">
                    <div class="professor-card wow fadeInRight" data-wow-delay=".4s">
                        <div class="professor-img global-img">
                            <img src="{{ asset('assets/frontend/img/professor/professor-1-2.png') }}" alt="professor image">
                        </div>
                        <div class="professor-content">
                            <h3 class="box-title">
                ...
                <div class="col-xl-6">
                    <div class="professor-card wow fadeInLeft" data-wow-delay=".6s">
                        <div class="professor-img global-img">
                            <img src="{{ asset('assets/frontend/img/professor/professor-1-3.png') }}" alt="professor image">
                        </div>
                        <div class="professor-content">
                            <h3 class="box-title">
                ...
                <div class="col-xl-6">
                    <div class="professor-card wow fadeInRight" data-wow-delay=".8s">
                        <div class="professor-img global-img">
                            <img src="{{ asset('assets/frontend/img/professor/professor-1-4.png') }}" alt="professor image">
                        </div>
                        <div class="professor-content">
                            <h3 class="box-title">
        ...
        <div class="professor-shape1 shape-mockup movingX d-none d-xl-inline-block" data-bottom="0%" data-right="2%">
            <img src="{{ asset('assets/frontend/img/shape/professor-2-1.png') }}" alt="Stadum">
        </div>
    </section>
    ...
    ==============================-->
                        <div class="swiper-slide">
                            <div class="campus-card style2">
                                <div class="box-thumb">
                                    <img src="{{ asset('assets/frontend/img/campus/campus-2-1.jpg') }}" alt="Icon">
                                </div>
                                <div class="campus-content">
                                    <a href="assets/img/campus/campus-v-2-1.jpg') }}" class="popup-image">
                        ...
                        <div class="swiper-slide">
                            <div class="campus-card style2">
                                <div class="box-thumb">
                                    <img src="{{ asset('assets/frontend/img/campus/campus-2-2.jpg') }}" alt="Icon">
                                </div>
                                <div class="campus-content">
                                    <a href="assets/img/campus/campus-v-2-2.jpg') }}" class="popup-image">
                                        <i class="fa-light fa-plus"></i>
                                    </a>
                                </div>
                                <div class="box-title-wrap">
                        ...
                        <div class="swiper-slide">
                            <div class="campus-card style2">
                                <div class="box-thumb">
                                    <img src="{{ asset('assets/frontend/img/campus/campus-2-3.jpg') }}" alt="Icon">
                                </div>
                                <div class="campus-content">
                                    <a href="assets/img/campus/campus-v-2-3.jpg') }}" class="popup-image">
                                        <i class="fa-light fa-plus"></i>
                                    </a>
                                </div>
                                <div class="box-title-wrap">
                        ...
                        <div class="swiper-slide">
                            <div class="campus-card style2">
                                <div class="box-thumb">
                                    <img src="{{ asset('assets/frontend/img/campus/campus-2-4.jpg') }}" alt="Icon">
                                </div>
                                <div class="campus-content">
                                    <a href="assets/img/campus/campus-v-2-4.jpg') }}" class="popup-image">
                                        <i class="fa-light fa-plus"></i>
                                    </a>
                                </div>
                                <div class="box-title-wrap">
                ...
                <button data-slider-prev="#campusSlider1" class="slider-arrow style2 slider-prev">
                    <img src="{{ asset('assets/frontend/img/icon/left-icon.svg') }}" alt="Stadum" class="th-arrow">
                </button>
                <button data-slider-next="#campusSlider1" class="slider-arrow style2 slider-next">
                    <img src="{{ asset('assets/frontend/img/icon/right-icon.svg') }}" alt="Stadum" class="th-arrow">
                </button>
            </div>
        </div>
    </section>
            ...
            <div class="row gy-30 justify-content-center">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="price-card  wow fadeInLeft" data-wow-delay=".2s">
                        ...
                        <div class="card-icon text-center">
                            <img src="{{ asset('assets/frontend/img/icon/pricing-icon-black.svg') }}" alt="Stadum">
                        </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="price-card active wow fadeInUp" data-wow-delay=".4s">
                        ...
                        <div class="card-icon text-center">
                            <img src="{{ asset('assets/frontend/img/icon/pricing-icon-white.svg') }}" alt="Stadum">
                        </div>
...
==============================-->
            ...
            <div class="swiper th-slider marquee-slider1" data-slider-options='{"breakpoints":{"0":{"slidesPerView":"auto"}},"autoplay":{"delay":0,"disableOnInteraction":false},"noSwiping":"true","speed":10000,"spaceBetween":40}'>
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="marquee-card">
                            <div class="color-masking">
                                <img src="{{ asset('assets/frontend/img/icon/open-book.svg') }}" alt="icon">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="marquee-card">
                            <div class="color-masking">
                                <img src="{{ asset('assets/frontend/img/icon/scollarship.svg') }}" alt="icon">
                            </div>
    ...
    <section class="faq-area-2 position-relative overflow-hidden space overflow-hidden" id="faq-sec">
        <div class="faq-shape shape-mockup jump" data-bottom="0%" data-right="2%"><img src="{{ asset('assets/frontend/img/shape/faq-2-1.png') }}" alt="Stadum"></div>
        <div class="container">
            <div class="row justify-content-lg-between justify-content-center align-items-center">
                <div class="col-lg-8 col-12">
                    <div class="title-area text-center text-lg-start">
    ...
    <div class="addmission-area overflow-hidden space-top overflow-hidden">
        <div class="addmission-bg-thumb overflow-hidden gsap-parallax">
            <img src="{{ asset('assets/frontend/img/bg/admission-home-2.png') }}" alt="Stadum">
        </div>
        <div class="container">
        ...
        <div class="container">
            <div class="admission-forum-inner">
                <div class="addmission-forum-thumb overflow-hidden">
                    <img src="{{ asset('assets/frontend/img/addmission/1.png') }}" alt="Stadum">
                </div>
    ...
    <section class="blog-area-2 overflow-hidden blog-area-2 space" id="blog-sec">
        <div class="blog-shape shape-mockup jump d-none d-xl-block" data-bottom="0%" data-right="2%"><img src="{{ asset('assets/frontend/img/shape/blog-2-1.png') }}" alt="Stadum"></div>
        <div class="container">
            <div class="row justify-content-lg-between justify-content-center align-items-center">
                <div class="col-lg-8 col-12">
                    <div class="title-area text-center text-lg-start">
            ...
            <div class="row gx-24 gy-30">
                <div class="col-xl-6">
                    <div class="blog-grid style2">
                        <div class="box-content">
                            <div class="blog-meta">
                                <a class="author" href="blog.html">
                                    <img src="{{ asset('assets/frontend/img/blog/author.png') }}" alt="img">By Themeholy
                                </a>
                        ...
                        <div class="blog-img">
                            <img src="{{ asset('assets/frontend/img/blog/blog_2_1.jpg') }}" alt="blog image">
                    ...
                    <div class="blog-grid style2 mt-30">
                        ...
                        <div class="blog-img">
                            <img src="{{ asset('assets/frontend/img/blog/blog_2_2.jpg') }}" alt="blog image">
                            <div class="blog-date style2">
                                <h5 class="blog-date-title">21</h5>
                                <p class="blog-date-text">June, 25</p>
                            </div>
                ...
                <div class="col-xl-6">
                    <div class="blog-grid">
                        <div class="blog-img">
                            <img src="{{ asset('assets/frontend/img/blog/blog_2_3.jpg') }}" alt="blog image">
                            <div class="blog-date style2">
                                <h5 class="blog-date-title">21</h5>
                                <p class="blog-date-text">June, 25</p>
                            </div>
